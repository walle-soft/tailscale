...
// fakeLocalServeClient is a fake implementation of LocalClient
// used by the serve command tests. It's not a full implementation,
// just enough to test the serve command.
//
...
type fakeLocalServeClient struct {
	...
	setCount uint // counts calls to SetServeConfig
}

// fakeStatus is a fake implementation of ipn.State.
